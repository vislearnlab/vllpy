"""
Util functions taken from https://github.com/eminorhan/silicon-menagerie/blob/master/utils.py
Cite: Orhan AE, Lake BM (2023) Learning high-level visual representations from a child's perspective without strong inductive biases. arXiv:2305.15372.
"""
import os
import sys
import torch
...
def build_dino_mugs(arch, patch_size):
    import vislearnlabpy.models.vision_transformer_dino_mugs as vits
